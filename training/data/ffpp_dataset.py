...
class FF_Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # rois = torch.tensor([[0.05, 0.05, 0.95, 0.95], l_eye_bbox, r_eye_bbox, nose_bbox, mouth_bbox])*10
        rois = torch.tensor([l_eye_bbox, r_eye_bbox, nose_bbox, mouth_bbox, [0.05, 0.05, 0.95, 0.95]])*10
