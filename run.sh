...
#srun -p create -w irip-cluster-compute-2 --gres=gpu:3080:4 -c 8 --mem 160G python main.py --gpus 0 1 2 3 --config configs/backbone.yaml
srun -p create -w irip-cluster-compute-2 --gres=gpu:3080:4 -c 8 --mem 160G python main.py --gpus 0 1 2 3 --config configs/xception.yaml
